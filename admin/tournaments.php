              ...
              <div class="col-sm-12">
                <section class="card">
                    ...
                    <header class="card-header">
                      <span class="card-title pull-left">Tournaments</span>
                        
                        <span class="tools float-right">
                          <a href="http://edinsoncs.com/myi/create-tournament.php" class="btn btn-sm btn-light btn-three f-14 mt-10">New</a>
                        </span>
                    </header>

                    <div class="card-body panel-body">
                      <div class="table-responsive">
                        <table  class="table display table-striped" id="tabletournaments">
                          <thead>
                            <tr>
                          ...
                          <tbody>
                            <tr class="gradeX">
                              ...
                              <td class="text-center"><img class="imgtable" src="assets/img/games/1.jpg" alt=""></td>
                              <td>IE's Aram Teams&Free Agents</td>
                              <td class="text-center">MYI Entertaiment</td>
                              <td class="text-center">Pre-Mades & Free Agents</td>
                              <td class="text-center">April 24, 2019 @ 2:30 am PDT</td>
                              <td class="text-center">Registration Open</td>
                              <td class="text-center">

                               <a href="http://edinsoncs.com/myi/create-tournament.php" class="mr-10 f-16"> <i class="fas fa-pencil-alt text-inverse" data-toggle="tooltip" data-original-title="Edit" data-placement="left"></i> </a> 
                               ...
                               <a href="http://edinsoncs.com/myi/details-tournaments.php" target="blank" class="mr-10 f-16" data-toggle="tooltip" data-original-title="View Profile" data-placement="left"> <i class="fa fa-eye t1"></i> </a>
                            ...
                            <tr class="gradeX">
                              ...
                              <td class="text-center">MYI Entertaiment</td>
                              <td class="text-center">Pre-Mades & Free Agents</td>
                              <td class="text-center">April 25, 2019 @ 2:30 am PDT</td>
                              <td class="text-center">Registration Open</td>
                              <td class="text-center">

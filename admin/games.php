...
<html lang="en">
              ...
              <div class="col-sm-12">
                <section class="card">
                    ...
                    <header class="card-header">
                      <span class="card-title pull-left">Games</span>
                        ...
                        <table  class="table display table-striped" id="tablegames">
                          ...
                          <tbody>
                            <tr class="gradeX">
                              ...
                              <td class="text-center"><img class="imgtable2" src="assets/img/games/1.jpg" alt=""></td>
                              <td class="text-center"><img class="imgtable3" src="assets/img/overviews/1.png" alt=""></td>
                              <td class="text-center">

                               <a href="#modal-game" data-toggle="modal" class="mr-10 f-16"> <i class="fas fa-pencil-alt text-inverse" data-toggle="tooltip" data-original-title="Edit" data-placement="left"></i> </a> 
  ...
  <script>
    ...
    reader.onload = function(){
      var output = document.getElementById('imagegame');
      $('#imggame').css('background-image', 'url(' + reader.result + ')');
    };
    ...
    var reader = new FileReader();
    reader.onload = function(){
      var output = document.getElementById('imageover');
      $('#imgover').css('background-image', 'url(' + reader.result + ')');
    };
    reader.readAsDataURL(event.target.files[0]);
    };
